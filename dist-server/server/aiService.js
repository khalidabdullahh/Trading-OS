...
exports.ServerAIService = void 0;
const env_1 = require("./env");
const db_1 = require("./db");
const strategyCompiler_1 = require("../services/strategyCompiler");
const strategyValidator_1 = require("../services/strategyValidator");
const performanceAnalytics_1 = require("../services/analytics/performanceAnalytics");
const ruleViolationEngine_1 = require("../services/trading/ruleViolationEngine");
class ServerAIService {
    /**
     * Server-Side Strategy Compilation
     */
    static async compileStrategy(promptText, symbol = "BTCUSDT", timeframe = "15m") {
...
3. Return ONLY a valid JSON object matching the StrategyAST interface.`;
        ...
        const offlineResult = strategyCompiler_1.StrategyCompiler.compileOffline(cleanPrompt, symbol, timeframe);
        return offlineResult;
    }
    /**
     * Server-Side Context-Aware AI Analyst
     */
    static async queryAnalyst(userId, promptText) {
        ...
        const metrics = performanceAnalytics_1.PerformanceAnalytics.calculate(trades);
        const sessionStats = performanceAnalytics_1.PerformanceAnalytics.breakdownBySession(trades);
        const violations = ruleViolationEngine_1.RuleViolationEngine.auditTrades(trades, plan, risk);
...
exports.ServerAIService = ServerAIService;
